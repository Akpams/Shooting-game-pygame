...
def run_game():
    ...
    screen = pygame.display.set_mode((settings_ai.screen_width, settings_ai.screen_height), pygame.FULLSCREEN)
    ...
    while True:
        gf.check_event(settings_ai, screen, stats, play_button, ship, alliens,bullets)
